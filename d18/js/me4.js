  ...
  var fnSuccess = function (result) {
    ...
    if (result.additionalUserInfo.isNewUser) {
      ...
      result.user.getIdToken().then(function (token) {
        ...
        jQuery
          .ajax({
            url: "https://i.resqme.com/prod/init",
            method: "GET",
            headers: {
              Authorization: token
            }
          ...
          .done(function (data) {
            ...
            ref
              ...
              .then(function (user) {
                ...
                // console.log(user);
                // call i.resqme.com for r_tkn
                jQuery
                  .ajax({
                    url: "https://i.resqme.com/prod/token",
                    method: "GET",
                    crossDomain: true,
                    xhrFields: {
      ...
      // but we need to get the resqme token
      result.user.getIdToken().then(function (token) {
        jQuery
          .ajax({
            url: "https://i.resqme.com/prod/token",
...
function signOut() {
  jQuery
    .ajax({
      url: 'https://i.resqme.com/prod/signout',
      method: "GET",
      crossDomain: true,
      xhrFields: {
        withCredentials: true
